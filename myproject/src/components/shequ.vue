<template>
    <div id="shequ">
      <div id="leader" @click="tap()">
        <div><span class="iconfont icon-hot-full" style="color:#fcdd13"></span><span style="color:#fcdd13">达人秀</span></div>
        <div><span class="iconfont icon-meishi"></span><span>咖社区</span></div>
        <div><span class="iconfont icon-shipin"></span><span>咖动态</span></div>
      </div>
      
      <div class="content1">
        <div style="display: block;">
            <div class="biaoti">
                <p><span class="iconfont icon-shouye1"></span>达人推荐</p>
                <p>MORE+</p>
            </div>
            <div id="daren">
            ...
            <div class="biaoti">
                <p><span class="iconfont icon-shouye1"></span>菜谱推荐</p>
                <p>MORE+</p>
            </div>
